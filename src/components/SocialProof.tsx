...
export function SocialProof() {
  ...
  const CommentCard = ({ review }: { review: any }) => (
    <div className="bg-white/5 backdrop-blur-md rounded-lg p-6 w-[380px] md:w-[450px] shrink-0 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 flex flex-col gap-3 shadow-[0_0_15px_rgba(239,68,68,0.15)] hover:shadow-[0_0_25px_rgba(239,68,68,0.3)]">
