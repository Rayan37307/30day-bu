...
export function Navbar() {
  return (
    <motion.nav 
      ...
      className="fixed top-6 left-1/2 -translate-x-1/2 z-50  flex items-center justify-between px-2 py-2 rounded-[14px] bg-navy-card shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),_0_20px_40px_rgba(0,0,0,0.6)] w-[95%] max-w-[1200px]"
    >
      {/* Left Logo */}
      <div className="flex items-center pl-1">
        <img 
          ...
          alt="Logo" 
          className="w-[46px] h-[46px] rounded-[14px] object-cover" 
